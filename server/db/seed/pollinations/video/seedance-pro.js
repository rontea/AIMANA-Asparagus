export const seedancePro = {
    id: 'pollinations-seedance-pro',
    label: 'Seedance Pro-Fast',
    description: 'BytePlus video generation with stronger prompt adherence.',
    provider: 'pollinations',
    category: 'Motion',
    iconName: 'Video',
    efficiencyTier: 'Tier-Video',
    isProgrammable: 1,
    capabilities: 'video,motion,seedance-pro',
    requestMethod: 'GET',
    requestUrl: 'https://gen.pollinations.ai/video/{{prompt}}?model=seedance-pro&seed={{seed}}&duration={{duration}}&aspectRatio={{aspectRatio}}&audio={{audio}}&image={{image}}',
    ...
    uiConfigJson: JSON.stringify([
        { key: 'duration', label: 'Duration (s)', type: 'slider', min: 2, max: 10, step: 1, default: 4, description: 'Seedance Pro supports 2-10 second clips.' },
